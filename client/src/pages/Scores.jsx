...
const BREAKDOWN_CONFIG = [
  ...
  { key: 'career', label: 'Career Development Plan', max: 10, icon: '🚀', desc: '10 pts for a fully completed plan (100% of the template, 20+ words per question). Sustain them with milestone progress notes: −5 if the 30-day note is missing, −3 more at 90 days, −2 more (all) at 6 months. Add a note (even late) to restore that milestone’s points.' },

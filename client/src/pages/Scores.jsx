...
const BREAKDOWN_CONFIG = [
  ...
  { key: 'lob', label: 'Line of Balance (LOB)', max: 8, icon: '📈', desc: '+1 pt for setting up a Line of Balance (4+ task rows and 4+ dates), +5 pts when every activity reaches 100% completion, and +2 bonus pts if you finish with no past-due (red) slips — 7 pts total if an activity ran late, 8 if it was flawless.' },

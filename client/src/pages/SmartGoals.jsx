...
export default function SmartGoals() {
  ...
  return (
    <div style={{ maxWidth: 860, margin: '0 auto' }} className="space-y-6">
      <PageHeader icon="🎯" title="SMART Goals — What does it mean winning?" subtitle="Set purposeful goals that drive accountability. Each goal contributes to your Accountability Score."
        action={
